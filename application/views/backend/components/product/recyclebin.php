									...
									<tbody>
										...
										<tr>
											...
											<td style="width:100px">
												<img src="<?php echo base_url()?>public/images/products/<?php echo $row['avatar'] ?>" alt="<?php echo $row['name'] ?>" class="img-responsive">
											</td>
											<td><?php echo $row['name'] ?></td>
											<td><?php $name=$this->Muser->user_name($row['created_by']); echo $name; ?></td>
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url()?>admin/product/restore/<?php echo $row['id'] ?>" role = "button">
											...
											<?php  
												...
												if($user['role']==1){
													$quyen.='
														<td class="text-center"><a class="btn btn-danger btn-xs" href="'.base_url().'admin/product/delete/'.$row['id'].'" role = "button">
